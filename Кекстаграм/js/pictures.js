...
var createMassive = function(fullMassive, lengthCreateveMassive) {
	...
	for (var f = 0; f < lengthCreateveMassive; f++) {
		...
		if (Math.round(Math.random())) {
			elem2 = fullMassive[Math.floor(Math.random() * fullMassive.length)];
		}
		randomMassive.push(`${elem1} ${elem2}`);
	}
	return randomMassive;
}
...
var pictureTemlate = document.querySelector('#picture-template').content.querySelector('.picture');
